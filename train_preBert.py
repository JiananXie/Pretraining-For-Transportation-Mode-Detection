...
def training(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.savefig('train_val_loss_acc.png')
...
if __name__ == '__main__':
    ...
    #读取数据
    data_train = pd.read_csv('data_train_loc_100000.csv')
    data_valid = pd.read_csv('data_valid_loc_100000.csv')
    data_test = pd.read_csv('data_test_loc_100000.csv')
